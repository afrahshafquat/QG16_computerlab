...
* And (&): Both statements on either side of the operator needs to be true
* Or (|): One of the statements on either side of the operator needs to be true
* Not (!): True only if the statement is False (vice versa)
